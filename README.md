# Saapasá Café — Website

Official website for **Saapasá Café**, Whitefield, Bengaluru — *where every flavour hits the right note.*

Built by [SnapSiteBuild.com](https://www.snapsitebuild.com).

## Structure
- `index.html` — main site (Design 1: warm glow)
- `design2.html` — alternate dark "Night Ritual" design
- `assets/` — optimized WebP photos, transparent dish cutouts, GSAP, storefront reel
...
5. Confirm the exact opening hour (schema currently assumes 09:00; closing 22:30 per Google).
6. Local keywords targeted: cafe in Whitefield, cafe near NVT Life Square, pizza/pasta Whitefield, Andhra avakaya rice bowl Bengaluru, aesthetic cozy cafe Whitefield, breakfast cafe Whitefield.
